...
start_experience_learning() {
  ...
  start_bg experience-learning "$LOG_DIR/experience-learning.log" \
    EXPERIENCE_LEARNING_LISTEN_ADDR="127.0.0.1:$EXPERIENCE_PORT" \
    EXPERIENCE_LEARNING_CONTROL_TOKEN="$INTERNAL_CONTROL_TOKEN" \
...
start_orchestrator() {
  ...
  start_bg orchestrator "$LOG_DIR/orchestrator.log" \
    ...
    ORCHESTRATOR_EXPERIENCE_LEARNING_CONTROL_TOKEN="$INTERNAL_CONTROL_TOKEN" \
...
start_bff() {
  ...
  start_bg c2c-bff "$LOG_DIR/c2c-bff.log" \
    ...
    C2C_EXPERIENCE_LEARNING_CONTROL_TOKEN="$INTERNAL_CONTROL_TOKEN" \
