...
| `orchestrator-service` | `schemas/agent-invocation-request-v0.json`, `schemas/agent-invocation-response-v0.json`, `schemas/agent-repair-decision-v0.json`, `schemas/agent-repair-input-v0.json`, `schemas/parity-build-result-v0.json`, `schemas/parity-comparison-result-v0.json`, `schemas/parity-execution-result-v0.json`, `schemas/parity-run-v0.json`, `schemas/patch-proposal-v0.json`, `schemas/intentional-divergence-decision-v0.json`, `schemas/repair-diagnosis-v0.json`, `schemas/trust-case-v0.json` |
