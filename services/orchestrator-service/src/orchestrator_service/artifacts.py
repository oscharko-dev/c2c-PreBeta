...
KIND_PARITY_REGRESSION_EXPORT_MANIFEST = "parity-regression-export-manifest"
KIND_PARITY_REGRESSION_PROJECT_MANIFEST = "parity-regression-project-manifest"
KIND_PARITY_REGRESSION_PROJECT_FILE = "parity-regression-project-file"
KIND_PARITY_REGRESSION_TEST_FILE = "parity-regression-test-file"
...
KIND_TRANSFORMATION_AGENT_PROJECT_FILE = "transformation-agent-project-file"
