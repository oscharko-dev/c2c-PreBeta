...
class TransformationAgentSuccessPersistenceTests(unittest.TestCase):
    ...
    def test_response_carries_required_w02_contract_fields(self) -> None:
        ...
        self.assertEqual(response["modelInvocationRef"]["agentRole"], "transformation")
        self.assertEqual(response["modelInvocationRef"]["policyDecision"], "policy allow")
        self.assertEqual(response["modelInvocationRef"]["policyId"], "foundry-development-v0")
        self.assertEqual(response["modelInvocationRef"]["promptTemplateVersion"], "v0")
        self.assertEqual(response["modelInvocationRef"]["status"], "completed")
