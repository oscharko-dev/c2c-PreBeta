...
export function UnsupportedConstructsPanel({ constructs }: UnsupportedConstructsPanelProps) {
  ...
  return (
    <Panel className="p-4 bg-orange-50 border border-orange-200 text-orange-900 mt-4">
      <h3 className="font-semibold mb-2 text-sm">Unsupported Features (W0 Scope)</h3>
