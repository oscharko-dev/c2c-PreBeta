    ...
    return (
      <div
        ...
        className={cn(
          ...
          {
            "bg-success border-success/20 shadow-success/20":
              variant === "success",
            ...
            "bg-orange border-orange/20 shadow-orange/20":
              variant === "blocked",
            "bg-violet border-violet/20 shadow-violet/20":
              variant === "incomplete",
            "bg-bg-3 border-line-2 shadow-black/20":
