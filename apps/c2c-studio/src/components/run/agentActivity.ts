...
export const ACTIVE_AGENT_DESCRIPTIONS: Record<W02ActiveAgent, string> = {
  transformation_agent: 'Producing the candidate Java translation from semantic IR.',
  verification_repair_agent: 'Reviewing the latest build/test outcome and proposing a repair.',
  ...
  build_test_runner: 'Compiling and executing the generated Java against the oracle.',
